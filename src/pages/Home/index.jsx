    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 leading-snug">
                첨단산업 인재혁신 특별법에 따른 <br className="hidden md:block" />
                제도 운영에 따른 지정(등록) 신청
                <br className="hidden md:block" />
                <span className="text-blue-600">유의사항</span>
              </h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                첨단산업 인재혁신 특별법에 따른 제도 운영에 따른 지정(등록)신청시 필수확인 사항을 안내합니다.
              </p>
              <button
            ...
            <div className="grid gap-6">
              <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">자주 찾는 정보</h3>
                </div>
      ...
      <section className="section">
        ...
        <div className="quick-grid">
          ...
          <button onClick={handleHomeClick} className="quick">
