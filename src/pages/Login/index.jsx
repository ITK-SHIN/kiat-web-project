      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="mt-6 text-sm text-gray-600 space-y-2 text-left">
              ...
              <p>- 기업용(범용,KIAT특수목적용) 공동인증서(기업)만 사용 가능합니다.</p>
              ...
              <div className="flex items-start gap-2 flex-1">
                ...
                <div className="text-sm text-blue-800 flex-1">
                  ...
                  <p className="leading-relaxed text-left">
                    신규지정(등록) 신청 및 보완 | 지정변경신고 및 보완 | 신고내역 보기
                  </p>
                  <p className="leading-relaxed text-left">
                    |지정(등록) 자진 취소 | 기업(단체) 지정 조회 | 당자 변경 |
                  </p>
                  <p className="leading-relaxed text-left">비밀번호 변경(인정번호 로그인) |</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="text-sm text-gray-600 space-y-2 text-left">
              <p>- 기업(단체) 비밀번호를 등록하면 공동인증서(기업) 없이 서비스를 이용할 수 있습니다.</p>
            ...
            <div className="mt-24 p-4 bg-red-50 rounded-md min-h-[140px] flex flex-col">
              <div className="flex items-start gap-2 flex-1">
                ...
                <div className="text-sm text-red-800 flex-1">
                  ...
                  <p className="leading-relaxed mb-2 text-left">-</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-3 text-sm text-gray-600 text-left">
            <p>
              • 현재 보안패치가 종료된 윈도우XP 및 익스플로러 8 이하 버전 사용시 시스템 이용이 정상적이지 않을
              수있습니다.
            </p>
            <p>
              • 가급적 윈도우7 서비스팩 1 이상의 OS 버전을 설치하고 인터넷 익스플로러(IE, Internet Explorer)를 10이상
              버전으로 설치해 주시기 바랍니다.
            </p>
          </div>
        </div>
